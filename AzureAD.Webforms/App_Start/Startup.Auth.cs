...
[assembly: OwinStartup(typeof(AzureAD.Webforms.Startup))]
...
namespace AzureAD.Webforms
{
    ...
    public class Startup
    {
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            //    {
            //        ClientId = "f2700fad-d566-4bd8-b195-94d52d7c5cb7",
            //        Authority = "https://login.windows.net/56f6ade5-04f9-47b9-bdf5-8f534d551a80"
            //    });
            app.UseOpenIdConnectAuthentication(
             new OpenIdConnectAuthenticationOptions
             {
        ...
        private Task OnAuthenticationFailed(AuthenticationFailedNotification<OpenIdConnectMessage, OpenIdConnectAuthenticationOptions> context)
        {
            try
            {
                ...
                if(context.Exception.Message.Contains("access_denied"))
